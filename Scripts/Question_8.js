...
function fnPrevious() {
    ...
    //alert("A-11");
    if (parseInt(PGNmbr) < parseInt(MaxPGNmbr)) {
        //  alert("A");
...
function fnSaveComments(X, FinalSave) {
    ...
    E360WebService.fnRspInsertRspComments(RspID, document.getElementById("MainContent_Textbox1").value, document.getElementById("MainContent_Textbox2").value, document.getElementById("MainContent_Textbox3").value, document.getElementById("MainContent_Textbox3").value, FinalSave, rsltRspInsertRspComments, rsltFailed, FinalSave + "^" + RspID);
}
...
$(document).ready(function () {
    ...
    //alert(PGNmbr);
    //alert(MaxPGNmbr);
    document.getElementById("dvName").innerHTML = "Think of how the below statements apply to :" + document.getElementById("MainContent_hdnName").value
    if (parseInt(PGNmbr) == 1) {
