...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br />
    <asp:GridView ID="grdWSMapping" runat="server" BorderWidth="1" class="table table-bordered table-sm mt-3" align="center" Width="80%" EmptyDataText="There is no record found" BorderStyle="Solid"
